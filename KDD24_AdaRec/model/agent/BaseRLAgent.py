...
bash_path = "/data1/zhxue/kuairand/CrossSessionRecSimulator-dev/"
...
class BaseRLAgent():
    ...
    def parse_model_args(parser):
        ...
        parser.add_argument('--filename', type=str, default="train_td3.py")
        return parser
    ...
    def __init__(self, args, facade: TwoRewardFacade):
        ...
        if len(self.n_iter) == 2:
            ...
            file_path = os.path.join(bash_path, args.filename)
            os.system(f"cp {file_path} {self.save_path}.config")
    ...
    def get_report(self):
        episode_report = self.facade.get_episode_report(self.check_episode)
